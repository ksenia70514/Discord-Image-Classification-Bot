...
bot = telebot.TeleBot("7880935948:AAFt3L9EVYSgrj2uc-DIQu3rNhs5dkzgKTU")
...
def handle_photo(message):
    if not message.photo:
        return bot.send_message(message.chat.id, 'нету картинки')
    ...
    with open(f'images/{file_name}','wb') as new_file:
        ...
        return bot.send_message(message.chat.id, 'картинка згружна')
# Запускаем бота
bot.polling()
